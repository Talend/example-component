...
@PartitionMapper(name = "ExamplePostgresInput")
@Documentation("TODO fill the documentation for this mapper")
public class ExamplePostgresMapper implements Serializable {
    private final ExamplePostgresMapperConfiguration configuration;
    private final ExampleComponentService service;
    private final RecordBuilderFactory recordBuilderFactory;

    public ExamplePostgresMapper(@Option("configuration") final ExamplePostgresMapperConfiguration configuration,
    ...
    @Split
    public List<ExamplePostgresMapper> split(@PartitionSize final long bundles) {
        ...
        // In this case bundles = 100 and we must try to return 10 ExamplePostgresMapper with 1/10 of the overall work each.
        //
    ...
    @Emitter
    public ExamplePostgresSource createWorker() {
        // here we create an actual worker,
        // you are free to rework the configuration etc but our default generated implementation
        // propagates the partition mapper entries.
        return new ExamplePostgresSource(configuration, service, recordBuilderFactory);
    }
}