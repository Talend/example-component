...
public class ExamplePostgresOutputTest {
    ...
    public void map() throws IOException {
        ...
        final ExamplePostgresOutputConfiguration configuration =  new ExamplePostgresOutputConfiguration()
                                                                                /* .setDataset() */;

        // We create the component processor instance using the configuration filled above
        final Processor processor = COMPONENT_FACTORY.createProcessor(ExamplePostgresOutput.class, configuration);
